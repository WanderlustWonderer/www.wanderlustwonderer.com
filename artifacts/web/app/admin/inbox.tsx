  ...
  return (
    <details ref={ref} id={`thread-${slug}`} open={defaultOpen} className={`scroll-mt-24 rounded-xl border bg-neutral-900 ${highlight ? "border-amber-500/40" : "border-neutral-800"}`}>
      ...
      <div className="space-y-3 border-t border-neutral-800 px-4 py-3">
        ...
        <div>
          <label className="text-xs text-neutral-300">Your reply{conv.latestDraft ? " (Draft — edit freely)" : ""}</label>
        ...
        <div className="rounded-lg border border-neutral-800 p-3">
          ...
          <div className="flex flex-wrap items-end gap-2">
            ...
            <label className="text-xs text-neutral-300">£<input type="number" value={price} min={1} step={1} onChange={(e) => setPrice(Number(e.target.value))} className="ml-1 w-16 rounded-md border border-neutral-700 bg-neutral-950 px-2 py-1 text-xs text-neutral-100" /></label>
